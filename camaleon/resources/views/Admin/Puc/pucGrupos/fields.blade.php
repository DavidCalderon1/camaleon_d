...
<div class="form-group col-sm-6">
	...
	{!! Form::select('clase_id', $pucClase, null, ['class' => 'form-control select_scroll', 'size' => '1', 'placeholder' => 'Seleccione una clase' ])!!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('admin.puc.grupos.index') !!}" class="btn btn-default">Cancelar</a>
</div>
