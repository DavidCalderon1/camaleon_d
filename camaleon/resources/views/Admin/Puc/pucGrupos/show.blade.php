...
@section('content')
	...
	<div class="row">
		@include('admin.puc.pucGrupos.show_fields')

		{!! Form::open(['route' => ['admin.puc.grupos.destroy', $pucGrupo->id], 'method' => 'delete']) !!}
			<div class="form-group col-sm-12">
				<a href="{{ URL::previous() }}" class="btn btn-default" role="button" title='Atras'><i class="glyphicon glyphicon-menu-left"></i> Atras</a>
				<a href="{!! route('admin.puc.grupos.edit', [$pucGrupo->id]) !!}" class='btn btn-primary' role="button" title='Editar'><i class="glyphicon glyphicon-edit"></i> Editar</a>
