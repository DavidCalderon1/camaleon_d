...
<div class="form-group col-sm-6">
	...
	{!! Form::select('cuenta_id', $pucCuenta, null, ['class' => 'form-control select_scroll', 'size' => '1', 'placeholder' => 'Seleccione una cuenta' ])!!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('admin.puc.subcuentas.index') !!}" class="btn btn-default">Cancelar</a>
</div>
